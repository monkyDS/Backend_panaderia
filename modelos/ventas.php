<?php
    class Ventas{
        ...
        public function consulta(){
            $con = "SELECT vent.*, c.nombre AS cliente, p.nombre AS productos, pr.razon_social As proveedor, u.nombre AS usuarios FROM ventas vent
        ...
        public function insertar($params){
            $ins = "INSERT INTO ventas(fecha, fo_cliente, fo_productos, fo_proveedor, cantidad, precios, iva, subtotales, total, fo_usuario)
                    VALUES('$params->fecha', $params->fo_cliente, $params->fo_productos, $params->fo_proveedor, '$params->cantidad', $params->precios, '$params->iva', $params->subtotales, $params->total, $params->fo_usuario)";
